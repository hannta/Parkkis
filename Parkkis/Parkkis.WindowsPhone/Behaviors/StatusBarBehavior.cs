...
namespace Parkkis.Behaviors
{
    ...
    public class StatusBarBehavior : DependencyObject, IBehavior
    {
        ...
        public static readonly DependencyProperty BackgroundOpacityProperty =  
            DependencyProperty.Register("BackgroundOpacity", typeof(double), typeof(StatusBarBehavior), new PropertyMetadata(0d, OnOpacityChanged));
